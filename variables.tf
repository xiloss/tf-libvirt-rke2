variable "stack_config" {
  ...
  default = {
    ...
    libvirt_volume_masters_disk_size    = 128849018880 # 53687091200 # 50GB 21474836480 # 20GB
    ...
    libvirt_network_agents_ips          = ["192.168.122.13", "192.168.122.14"] # , "192.168.122.14", "192.168.122.14"]
